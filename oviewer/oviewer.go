...
type SCR struct {
	...
	// continueSignStyle is the style of the continuation sign.
	continueSignStyle tcell.Style
	...
	breakSignWidth int
	// continueSignWidth is the width of the continuation sign.
	continueSignWidth int
