...
var keyBindDescriptions = []KeyBindDescription{
	...
	{Group: GroupGeneral, Action: actionWriteBA, Description: "set before/after range to output to terminal on exit"},
	{Group: GroupGeneral, Action: actionWriteOriginal, Description: "toggle outputting current view to terminal on exit"},
