...
func Test_parseString(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want1: map[int]int{0: 0, 1: 1, 2: 2, 3: 3, 4: 4},
		},
		{
			name: "testASCII",
			...
			want1: map[int]int{0: 0, 1: 1, 2: 2, 3: 3},
		},
		{
			name: "testHiragana",
		...
		},
		{
			...
			want1: map[int]int{0: 0, 1: 1, 2: 2, 3: 3, 6: 5},
		},
		{
			name: "testTab",
			...
			want1: map[int]int{0: 0, 1: 1, 2: 4, 3: 5},
		},
		{
			name: "testTabMinus",
			...
			want1: map[int]int{0: 0, 1: 1, 2: 1, 3: 3, 4: 4},
		},
		{
			name: "red",
			args: args{
		...
		},
		{
			...
			want1: map[int]int{0: 0, 1: 1, 2: 0, 3: 1},
		},
		{
		...
		},
		{
			...
			want1: map[int]int{0: 0, 3: 2, 4: 0, 7: 2},
		},
		{
			name:  "testOverstrike4",
			args:  args{line: "\a", tabWidth: 8},
			want:  nil,
			want1: map[int]int{0: 0, 1: 0},
		},
		{
		...
		},
		{
			...
			want1: map[int]int{0: 0, 1: 1, 2: 0, 5: 2},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, got1 := parseString(tt.args.line, tt.args.tabWidth)
